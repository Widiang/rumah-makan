...
<body>
    <main id="main" class="main">
        <div class="container">
            <form action="<?= base_url('home/aksi_TambahEdit')?>" method="post">
                <div class="pagetitle">
                    <h1>Order</h1>
                            ...
                            <div class="col-lg-10">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3 mt-3">
                                            <label for="Deskripsi" class="form-label">Nomor</label>
                                            <input class="form-control" id="Deskripsi" value="<?= $sa->Nomor ?>" name="nomor"></input>
                                        </div>
                                        <div class="mb-3 mt-3">
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-6 col-lg-6">
                                                ...
                                                <select name="jenis1[]" class="form-control" id="menuMakanan" onchange="updateTotalHarga()">
                                                    <option value="14" data-total-harga="<?= $sa->total_harga ?>"></option>
                                            ...
                                            <div class="col-md-5 col-lg-5">
                                                ...
                                                <input class="form-control total-field" id="totalMakanan" name="totalM" style="width: 100%;"  onchange="updateTotalHarga()">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-6 col-lg-6">
                                                ...
                                                <select name="jenis2[]" class="form-control" id="menuMinuman" onchange="updateTotalHarga()">
                                                    <option value="5" data-total-harga="<?= $sa->total_harga ?>"></option>
                                            ...
                                            <div class="col-md-5 col-lg-5">
                                                ...
                                                <input class="form-control total-field" id="totalMinuman" name="totalMI" style="width: 100%;"  onchange="updateTotalHarga()">
                                            </div>
                                        </div>
